...
- Target templates/apps (e.g., `apps/react-app`, `apps/go-modular`).
- High-level diagram or bullet list of services and their responsibilities.
- Integration points (internal packages, external APIs, infrastructure stacks).
